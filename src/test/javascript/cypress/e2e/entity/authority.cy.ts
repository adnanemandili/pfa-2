...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '64b52fbc-130d-4bbf-91e3-a32e90b7a768' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('1c3c92f0-2f41-4d38-b0be-568aeb105c8f');
      cy.get(`[data-cy="name"]`).should('have.value', '1c3c92f0-2f41-4d38-b0be-568aeb105c8f');
